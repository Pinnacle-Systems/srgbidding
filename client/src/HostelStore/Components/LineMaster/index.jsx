...
import { useAddLineMasterMutation, useDeleteLineMasterMutation, useGetLineMasterByIdQuery, useGetLineMasterQuery, useUpdateLineMasterMutation } from "../../../redux/services/LineMasterService";
...
export default function Form({ onSuccess, defaultName = "" }) {
  ...
  const saveData = (nextProcess) => {
    ...
    if (foundItem) {
      Swal.fire({
        text: "The Line No already exists.",
        icon: "warning",
        didClose: () => {
          countryNameRef?.current?.focus();
        }
  ...
  return (
    <div onKeyDown={handleKeyDown} className="p-1 h-[87%]">
      <div className="w-full flex bg-white p-1 justify-between  items-center">
        <h5 className="text-lg font-bold text-gray-800">Line Master</h5>
