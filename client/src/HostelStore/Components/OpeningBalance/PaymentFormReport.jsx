...
import { useGetOpeningBalanceQuery } from "../../../redux/services/OpeningBalanceService";
...
const PaymentFormReport = ({
    ...
    const { data: allData, isLoading, isFetching } = useGetOpeningBalanceQuery({ params: { branchId, ...searchFields, pagination: true, dataPerPage, pageNumber: currentPageNumber } });
            ...
            <>
                <div className="h-[100vh] rounded-lg bg-[#F1F1F0] shadow-sm">
                    <div className="h-[68vh]">
                        <table className="w-[75vw] table-fixed">
                            <thead className="bg-gray-200 text-gray-800 table-fixed">
                                <tr className="">
                                    <th className=" px-1 py-1.5  font-medium text-[13px]  text-gray-900  text-center  w-12">
                                        <div className="">S No</div>
                                    </th>

                                    <th className="  font-medium text-[13px]  text-gray-900  text-center w-40">
                                        <div>Opening Balance No</div>
                                    </th>

                                    <th className=" px-3  font-medium text-[13px]  text-gray-900  text-center w-40">
                                        <div>Opening Balance Date</div>
                                    </th>
                                    <th className=" px-3  font-medium text-[13px]  text-gray-900  text-center w-32">
                                        <div>Category</div>
                                    </th>

                                    <th className="w-88     font-medium text-[13px] text-gray-900  text-center ">
                                        <div>Customer / Supplier Name</div>
                                    </th>
                                ...
                                <tr className="">
                                    ...
                                    <th className="  font-medium text-[13px] border  text-gray-900  text-center">
                                        <input
                                            type="text"
                                ...
                                <tbody className="border-2">
                                    {(allData?.data ? allData?.data : []).map((dataObj, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-1.5 text-left uppercase"> {dataObj?.partCategory}</td>
...
export default PaymentFormReport