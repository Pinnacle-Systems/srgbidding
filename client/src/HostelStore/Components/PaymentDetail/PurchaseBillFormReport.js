...
//         <div className="heading text-center md:mx-10">Payment Report </div>
...
import { useGetDeliveryInvoiceQuery } from "../../../redux/services/DeliveryInvoiceService";
import { useGetPaymentQuery } from "../../../redux/services/PaymentService";



const PayemntFormReport = ({
  onClick,
  onView,
  itemsPerPage = 10,
  onEdit,
...
export default PayemntFormReport;
