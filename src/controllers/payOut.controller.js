...
import { get as _get, getOne as _getOne, getSearch as _getSearch, create as _create, update as _update, remove as _remove } from '../services/payOut.service.js';
...
async function getOne(req, res, next) {
    try {
        res.json(await _getOne(req.params.id, req.params.advanceAdjustmentId));
        console.log(res.statusCode);
    } catch (err) {
        console.error(`Error`, err.message);
    }
